package com.phoenix.vendido.buysell.widgets
 ...
 */
class CurrentPlanShinnyTextView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : AppCompatTextView(context, attrs, defStyleAttr) {
    ...
    private fun generateGradientShader(width: Int, vararg positions: Float): Shader {
        val colorRepartition = intArrayOf(ContextCompat.getColor(context, R.color.dark_green),
                Color.YELLOW, ContextCompat.getColor(context, R.color.dark_green))
